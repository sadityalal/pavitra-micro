            ...
            <div className="col-lg-3 col-md-6" key={product.id}>
              <div className="product-item" style={{cursor: 'pointer'}}>
                <div className="product-image">
                  ...
                  <img src={product.main_image_url || '/static/img/product/placeholder.jpg'} alt={product.name} className="img-fluid" loading="lazy" onError={(e)=>e.currentTarget.src='/static/img/product/placeholder.jpg'} />
